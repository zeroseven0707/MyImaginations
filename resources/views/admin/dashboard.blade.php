...
<section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">{{ $bookmark }}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-warning elevation-1"><img src="img/mata.png" alt=""></span>
              <div class="info-box-content">
                <span class="info-box-text">Look</span>
                <span class="info-box-number">{{ $look }}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
